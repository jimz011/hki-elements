...
Person/device location tracking view. Shared as-is from my own Home Assistant dashboard for reference/inspiration — entity IDs, sensors, and automations are specific to my setup and won't work unmodified in yours.
  ...
  - type: sections
    ...
    header:
      card:
        ...
        title: Find My
        subtitle: Persons and Items
        background: >-
          https://storage.googleapis.com/gweb-uniblog-publish-prod/images/find_device_keyword_illustration_2024_2-03_1.width-1300.png
        min_height: 215
        max_height: 270
        title_offset_y: 65
