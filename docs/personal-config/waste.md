...
Waste/garbage collection schedule. Shared as-is from my own Home Assistant dashboard for reference/inspiration — entity IDs, sensors, and automations are specific to my setup and won't work unmodified in yours.
  ...
  - type: sections
    ...
    sections:
      - type: grid
        cards:
          ...
          - entities:
              - calendar.afvalbeheer_deafvalapp
            days_to_show: 56
    ...
    header:
      card:
        ...
        subtitle: Schedule
        background: >-
          https://t3.ftcdn.net/jpg/02/16/47/80/360_F_216478056_TDyEbEmQ6sGvFjRCZhgmmhC1SyfU0cGJ.jpg
        min_height: 215
        max_height: 270
        title_offset_y: 65
