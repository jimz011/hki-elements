  ...
  - type: sections
    ...
    header:
      card:
        ...
        title: Bathroom
        subtitle: |
          {% if is_state('media_player.badkamer_speaker', 'playing') %}
            Music: {{ state_attr('media_player.badkamer_speaker', 'media_artist') }} - {{ state_attr('media_player.badkamer_speaker', 'media_title') }}
          {% else %}
            No Media is Playing
          {% endif %}
        background: /local/images/rooms/bathroom.jpg
        min_height: 215
        max_height: 270
        title_offset_y: 65
    ...
    badges:
      ...
      - type: custom:hki-button-card
        ...
        hki_popup:
          ...
          blur_amount: 10
      - type: custom:hki-button-card
        entity: humidifier.comfee_dehumidifier
        card_layout: badge
        show_name: false
        show_state: false
        tap_action:
        ...
        humidifier:
          ...
          show_plus_minus: true
          fan_entity: select.comfee_dehumidifier_fan_speed
          show_gradient: true
```
