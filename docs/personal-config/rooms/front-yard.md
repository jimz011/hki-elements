  ...
  - type: sections
    ...
    header:
      card:
        ...
        title: Front Yard
        subtitle: We should probably maintain this better
        background: /local/images/rooms/frontyard.png
        min_height: 215
        max_height: 270
        title_offset_y: 65
    ...
    badges:
      - type: custom:hki-button-card
        card_layout: badge
        entity: sensor.aqara_th_buiten_temperature
        name: Temperature
      ...
      - type: custom:hki-button-card
        ...
        tap_action:
          action: hki-more-info
        icon: |-
          {% if is_state('binary_sensor.aqara_door_voordeur_contact', 'on') %}
            mdi:door-open
        ...
        styles:
          ...
          icon:
            color: >-
              ...
              {% endif %}
        lock:
          contact_sensor_entity: binary_sensor.aqara_door_voordeur_contact
      - type: custom:hki-button-card
        entity: camera.deurbel_voor_high_resolution_channel
        card_layout: badge
        show_name: false
        hold_action:
          action: none
