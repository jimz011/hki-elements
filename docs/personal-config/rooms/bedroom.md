  ...
  - type: sections
    ...
    header:
      card:
        ...
        title: Bedroom
        subtitle: >
          {% if is_state('media_player.slaapkamer_display_steph', 'playing') %}
            Music: {{ state_attr('media_player.slaapkamer_display_steph', 'media_artist') }} - {{ state_attr('media_player.slaapkamer_display_steph', 'media_title') }}
          {% elif is_state('media_player.slaapkamer_display_jimmy', 'playing')
          %}
            Music: {{ state_attr('media_player.slaapkamer_display_jimmy', 'media_artist') }} - {{ state_attr('media_player.slaapkamer_display_jimmy', 'media_title') }}
          {% else %}
            No Media is Playing
          {% endif %}
        background: /local/images/rooms/bedroom.jpg
        min_height: 215
        max_height: 270
        title_offset_y: 65
    ...
    badges:
      ...
      - type: custom:hki-button-card
        ...
        hki_popup:
          ...
          blur_amount: 10
      - type: custom:hki-button-card
        entity: cover.gordijnen_slaapkamer
        card_layout: badge
        show_name: false
        show_state: false
        icon: |-
        ...
        hki_popup:
          ...
          blur_amount: 10
      - type: custom:hki-button-card
        entity: fan.air_purifier_3c_fan
        card_layout: badge
        show_name: false
        show_state: false
        tap_action:
